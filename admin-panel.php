...
include('func.php');  
include('newfunc.php');
$con=mysqli_connect("localhost","root","qwer1234.","myhmsdb");
...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> FAST HOSPITALs</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> FAST HOSPITAL </a>
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left, #0ce05e, #05f76a);
}
.list-group-item.active {
    z-index: 2;
    color: #fff;
    background-color: #0ae928;
    border-color: #0ae928;
}
.text-primary {
